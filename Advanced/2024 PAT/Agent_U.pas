...
uses
  ...
  Spin, Client, IOUtils, ListingDetails; // NEW
...
type
  TfrmAgent = class(TForm)
    ...
    Label8: TLabel;
    Label9: TLabel;
    btnQuickLinksAddClient: TButton;
    btnQuickLinksAddProperty: TButton;
    btnQuickLinksCreateListing: TButton;
    ...
    btnPropertiesReports: TPanel;
    tbsPropertiesReports: TTabSheet;
    ...
    pnlClientsAssignPropertiesCurrentClient: TPanel;
    ...
    tbsClientsSelectClient: TTabSheet;
    pnlClientsSelectClient: TPanel;
    ...
    redPropertiesReports: TRichEdit;
    ...
    procedure btnClientsReportsClick(Sender: TObject);
    ...
    procedure btnPropertiesReportsClick(Sender: TObject);
  ...
  private
    ...
    fListingManager : TListingDetailsManager; // NEW
...
begin
  ...
  begin
    ...
    if MessageDlg('Are you sure you want to delete ' + tblClients['FirstName'] + '?', mtWarning, [mbYes, mbNo], 0) = mrYes then
    begin
      dsClients.DataSet := qryClients;
      qryClients.SQL.Clear;
...
procedure TfrmAgent.btnClientsDetailsManagePropertiesClick(Sender: TObject);  // NEW
begin
  tbsClientsDetailsProperties.Show;
  pnlClientsCurrentPage.Caption := 'Details';
end;

procedure TfrmAgent.btnClientsReportsClick(Sender: TObject); // NEW
begin
  tbsClientsReports.Show;
  pnlClientsCurrentPage.Caption := 'Reports';
end;

procedure TfrmAgent.btnPropertiesAddClick(Sender: TObject);    // NEW
begin
...
procedure TfrmAgent.btnPropertiesDetailsClick(Sender: TObject);  // NEW
begin
  tbsPropertiesDetails.Show;
  pnlPropertiesCurrentPage.Caption := 'Details';
end;

procedure TfrmAgent.btnPropertiesReportsClick(Sender: TObject);
begin
  tbsPropertiesReports.Show;
  pnlPropertiesCurrentPage.Caption := 'Reports';
end;
...
//    tblClients.Active := True;
    ...
    dsClients.DataSet := qryClients; // NEW
  end;
...
procedure TfrmAgent.dbgOffersCellClick(Column: TColumn); // NEW
var
...
begin
  ...
  begin
    ...
    //fListingManager.Add(iGridPropertyID);
...
begin
  ...
  pnlQuickLinksWidget.Color := clSkyBlue;
...
var
  iID : integer;
begin
  iID := StrToInt(InputBox('ClientID', 'Enter the ClientID', ''));
...
procedure TfrmAgent.pnlManageOffersClick(Sender: TObject);   // NEW
var
  sSQL : string;
begin
  tbsOffers.Show;
...
procedure TfrmAgent.pnlOffersAcceptClick(Sender: TObject);   // NEW
var
  iOwnerID : integer;
begin
  with dmPropertyHub do
  begin
    ...
    dsOwners.DataSet := qryOwners;
    qryOwners.SQL.Clear;
    qryOwners.SQL.Add('DELETE FROM tblOwners WHERE PropertyID = ' + IntToStr(iOfferPropertyID));
    qryOwners.ExecSQL;
...
procedure TfrmAgent.pnlOffersViewMoreDetailsClick(Sender: TObject); // NEW
var
  i : integer;
begin
  tbsPropertiesDetails.Show;
