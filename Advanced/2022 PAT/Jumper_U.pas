...
uses
  ...
  Dialogs, ExtCtrls, jpeg, math, Buttons, StdCtrls, pngimage,OleCtrls,
  WMPLib_TLB;
...
type
  ...
  private
    ...
    iScore : integer;
    iEnemy1Show, iEnemy2Show, iEnemy3Show, iEnemy4Show, iEnemy5Show,
    iEnemy6Show : integer;
    bEnemy1Available, bEnemy2Available, bEnemy3Available, bEnemy4Available,
    bEnemy5Available, bEnemy6Available: boolean;
...
begin
  ...
  begin
    ...
    begin
      ...
      pnlLostHighScore.Caption := IntToStr(iHighScoreJ);
...
begin
  if (iScore = iEnemy1Show) AND (tmrEnemy1Move.Enabled = False) then
  //Create Enemy1
  begin
  ...
  if (iScore = iEnemy2Show) AND (tmrEnemy2Move.Enabled = False) then
  //Create Enemy2
  begin
  ...
  if (iScore = iEnemy3Show) AND (tmrEnemy3Move.Enabled = False) then
  //Create Enemy3
  begin
  ...
  if (iScore = iEnemy4Show) AND (tmrEnemy4Move.Enabled = False) then
  //Create Enemy4
  begin
  ...
  if (iScore = iEnemy5Show) AND (tmrEnemy5Move.Enabled = False) then
  //Create Enemy5
  begin
  ...
  if (iScore = iEnemy6Show) AND (tmrEnemy6Move.Enabled = False) then
  //Create Enemy6
  begin
