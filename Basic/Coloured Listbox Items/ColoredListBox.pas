...
type
  ...
  public
    ...
    procedure ColoredDrawItem(Control: TWinControl; Index: Integer; Rect: TRect; State: TOwnerDrawState);
...
procedure TColoredListBox.ColoredDrawItem(Control: TWinControl; Index: Integer; Rect: TRect; State: TOwnerDrawState);
var
  ColorStr: string;
  ItemColor: TColor;
  ListBox: TListBox;
